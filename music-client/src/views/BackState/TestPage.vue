<template>
    <div class="singer-info">
        ...
        <!-- 分页 -->
        <el-pagination background layout="prev, pager, next" :total="filteredSingers.length" :page-size="pageSize" v-model:current-page="currentPage" @current-change="handlePageChange" />
